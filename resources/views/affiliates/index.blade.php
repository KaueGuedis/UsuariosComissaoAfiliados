    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                @else
                    <form action="{{ route('affiliates.activate', $affiliate->id) }}" method="POST" style="display: inline-block;">
                        @csrf
                        <button class="btn btn-sm btn-success" onclick="return confirm('Deseja ativar este afiliado?')">Ativar</button>
                    </form>
                @endif
            </td>
        </tr>
